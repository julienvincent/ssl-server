...
exports.default = function (config) {
    ...
    if (config.production) {
        var _ret = function () {
            ...
            var httpMiddleware = config.httpRedirect ? (0, _redirectHttps2.default)() : config.app;

            var ACMEHandler = _http2.default.createServer(Handler.middleware(httpMiddleware));
                ...
                v: {
                    listen: function listen(redirect, primary) {
                        ...
                        ACMEHandler.listen(redirect, function () {
                            return console.log('Handling challenges ' + (config.httpRedirect ? "and redirecting to https" : ""));
                        });
